...
void LoadDefaultGUI()
{
	if (v_driver > 0)
	{
		...
		//TinyCTF
		AddIconToken("$2x2saw$", "2x2saw.png", Vec2f(16, 16), 3);
		AddIconToken("$TinyDrill$", "TinyDrill.png", Vec2f(12, 9), 0);
		AddIconToken("$TCTFbuilding$", "TCTFbuilding.png", Vec2f(16, 16), 0);
		AddIconToken("$TCTFboatshop$", "TCTFboatshop.png", Vec2f(16, 16), 0);
		AddIconToken("$TCTFbuildershop$", "TCTFbuildershop.png", Vec2f(16, 16), 0);
		AddIconToken("$TCTFknightshop$", "TCTFknightshop.png", Vec2f(16, 16), 0);
		AddIconToken("$TCTFquarters$", "TCTFquarters.png", Vec2f(16, 16), 0);
		AddIconToken("$TCTFstorage$", "TCTFstorage.png", Vec2f(16, 16), 0);
		AddIconToken("$TCTFtunnel$", "TCTFtunnel.png", Vec2f(16, 16), 0);
		AddIconToken("$TCTFvehicleshop$", "TCTFvehicleshop.png", Vec2f(16, 16), 0);
		AddIconToken("$TCTFarchershop$", "TCTFarchershop.png", Vec2f(16, 16), 0);
	}
}
