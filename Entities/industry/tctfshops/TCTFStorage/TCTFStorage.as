...
void onInit(CSprite@ this)
{
	...
	// Stone
	CSpriteLayer@ stone = this.addSpriteLayer("mat_stone", "TCTFStorageLayers.png", 16, 16);
	if (stone !is null)
	{
		{
		...
		stone.SetOffset(Vec2f(0.0f, 0.0f));
		stone.SetRelativeZ(1);
		stone.SetVisible(false);
	}

	// Wood
	CSpriteLayer@ wood = this.addSpriteLayer("mat_wood", "TCTFStorageLayers.png", 16, 16);
	if (wood !is null)
	{
		{
		...
		wood.SetOffset(Vec2f(0.0f, 0.0f));
		wood.SetRelativeZ(1);
		wood.SetVisible(false);
	}

	// Gold
	CSpriteLayer@ gold = this.addSpriteLayer("mat_gold", "TCTFStorageLayers.png", 16, 16);
	if (gold !is null)
	{
		{
		...
		gold.SetOffset(Vec2f(0.0f, 0.0f));
		gold.SetRelativeZ(1);
		gold.SetVisible(false);
	}

	// Bombs
	CSpriteLayer@ bombs = this.addSpriteLayer("mat_bombs", "TCTFStorageLayers.png", 16, 16);
	if (bombs !is null)
	{
		{
		...
		bombs.SetOffset(Vec2f(0.0f, 0.0f));
