...
{
	CSpriteLayer@ bed = this.addSpriteLayer("bed", "TCTFQuarters.png", 16, 16);
	if (bed !is null)
	{
		{
		...
		bed.SetOffset(Vec2f(0, 0));
		bed.SetVisible(true);
	}

	CSpriteLayer@ zzz = this.addSpriteLayer("zzz", "TCTFQuarters.png", 8, 8);
	if (zzz !is null)
	{
		{
	...
	CSpriteLayer@ backpack = this.addSpriteLayer("backpack", "TCTFQuarters.png", 16, 16);
	if (backpack !is null)
	{
		{
